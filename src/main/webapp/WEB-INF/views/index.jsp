...
<body onload="document.getElementById('textarea').scrollTop = textarea.scrollHeight">
...
<td><input type="button" value="ListStoredChangelogs" name="radiogroup" onClick="window.location.href='http://localhost:8081/geosync_client/ListStoredChangelogs?datasetId='+$('#datasetId').val()"></td>
...
<tr>
<td colspan="8"><form method="post" action="">
<textarea name="comments" cols="120" rows="5" id="textarea">
<c:forEach items="${lastIndex}" var="text">
${text}
</c:forEach>
</textarea><br>
</form>
